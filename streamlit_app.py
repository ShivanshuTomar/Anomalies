...
# elif selected_anomalyAlgorithm == "K Means Clustering":
#     st.markdown(
...
#         data_with_anomalies_KMeans = apply_anomaly_detection_KMeans(data)
...
#                 labels={selected_x_col: selected_x_col, selected_y_col: selected_y_col, selected_z_col: selected_z_col, "Anomaly_KMeans": 'Anomaly', "PointColor": "Data Type"},
#             )
#             fig.update_traces(
#                 marker=dict(size=8, opacity=0.7, line=dict(width=2, color='DarkSlateGrey')),
#                 selector=dict(mode='markers+text')
